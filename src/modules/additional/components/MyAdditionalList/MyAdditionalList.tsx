...
import type {MyAdditionalCardType} from "../../types/MyAdditionalCard.ts";

const items: MyAdditionalCardType[] = [
  {
    id: 1,
    title: "Схема Гродековского музея"
  },
  {
    id: 2,
...
export function MyAdditionalList() {
  return (
